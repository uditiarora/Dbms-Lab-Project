...
{          
    ...
    if($_POST['action']=="login")
    {
        ...
        $_SESSION['check'] = 1;
        $strSQL = mysqli_query($db,"select first_name from user where email_id='".$email_id."' and password='".md5($password)."'");
        $Results = mysqli_fetch_array($strSQL);
        if(mysqli_num_rows($strSQL) && count($Results)>=1)
        {
            header('Location:http://localhost:81/WebD/Web/resume.php');
        }
        else
        {
  ...
  <div class="form">
      <div class="outer">
        ...
        <div id="login">   
          ...
          <p class="forgot"><a href="http://localhost:81/WebD/Login/forget.php">Forgot Password?</a></p>
