...
$q6 = "select * from ins where email_id='".$email_id."'";
$q7 = "select * from courses where email_id='".$email_id."'";
$q8 = "select * from courses where email_id='".$email_id."'";
...
$q12 = "select * from ins where email_id='".$email_id."'";
...
<!--[if lt IE 7]>
   ...
   <div class="main-container">
          ...
          <!-- Tab List -->
            <ul class='etabs'>
                <li class='tab' id="tab-about">
                  <a href="#about"><i class="icon-user"></i><span>Course List</span></a>
                </li>
                <li class='tab'>
                ...
                <div id="about">
                    <section class="clearfix">
                        <div class="g2">
                            ...
                            <div class="info">
                                 <?php  while($a12=mysqli_fetch_array($result12))  {  ?>

                                    <h2>
                                        <?php echo " ".$a12[1]." ".$a12[2]." " ; ?>
                                    </h2>
                                  ...
                                  <?php  while($a8=mysqli_fetch_array($result8))  {  ?>
                                    ...
                                    <h5>
                                        <a href="coursepage.php"><?php echo " ".$a8[1]."\n"; ?></a>
                                    </h5>
    ...
    <a href="remove_about.php"><p>Remove Course</p></a>
    ...
    <br><br>
    <a href="remove_exp.php"><p>Remove Experience</p></a>
                            ...
                            <ul class="no-list work">
                                <li>
                                  ...
                                  <br><br>
    						<a href="remove_edu.php"><p>Remove Qualification</p></a>
                                </li>
                            </ul>
                        </div>
                        <div class="g1">
                            <div class="sidebar">
                                ...
                                <br><br>
    						<a href="remove_software.php"><p>Remove Software</p></a>
                                <div class="break"></div>
                                <h5>
                                    Design
                                </h5>
                                ...
                                <br><br>
    						<a href="remove_design.php"><p>Remove Design</p></a>
                                <div class="break"></div>
                                <h5>
                                ...
                                <br><br>
    						<a href="remove_pl.php"><p>Remove Programming Language</p></a>
                            </div>
                        </div>
                    </section>
                </div>
     ...
     <a href="add_contact.php"><i class="fas fa-plus" style="color:lightblue;font-size:50px;margin-left:300px"></i>
    						...
    						<a href="remove_contact.php"><p>Remove Details</p></a>
...
<footer>
	<a href="http://localhost:81/WebD/LoginIns/logout.php"><h2>Log Out</h2></a>
</footer>
