...
{          
    ...
    if($_POST['action']=="signup")
    {
        ...
        $query = "SELECT email_id FROM ins where email_id='".$email_id."'";
        ...
        {
$query2 = "insert into ins(email_id,first_name,last_name,password) values('".$email_id."','".$first_name."','".$last_name."','".md5($password1)."')";
