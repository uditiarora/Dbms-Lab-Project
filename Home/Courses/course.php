...
$q1="select * from videos where email_id='".$email_id."' and course='".$course."'";
               ...
               <article class="post-1 line">
                  ...
                  <div class="s-12 l-5 post-text">
                      <?php  while($a1=mysqli_fetch_array($result1))  {  ?>
                                    ...
                                    <h2>
                                 <video src = "<?php echo $a1[2] ; ?>" width = "400" controls>               

                                       <a href="course.php?data=<?php echo $a1[0] ; ?> data1=<?php echo $a1[1] ; ?>" ><?php echo " ".$a1[1]." " ; ?></a>
                                    </h2>
